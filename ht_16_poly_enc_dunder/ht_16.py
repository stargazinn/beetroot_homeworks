...
#         # якщо передавати параметр як значення за замовчуванням books = [] і коли цей параметр не передавати явно,
#         # то при зміні списку одним об'єктом класу, ця зміна буде відображатися в усіх об'єктах класу
